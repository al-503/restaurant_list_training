...
ActiveRecord::Schema.define(version: 2021_12_11_171532) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["restaurant_list_id"], name: "index_bookmarks_on_restaurant_list_id"
  end
  ...
  add_foreign_key "bookmarks", "restaurant_lists"
